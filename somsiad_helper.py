...
if not os.path.exists(conf_file):
    with open(conf_file, "w") as f:
        ...
        f.write("youtube: " + str(input("Wprowadź klucz API YouTube (lub pomiń, jeśli nie chcesz funkcji YT):\n")) + "\n")
...
client = Bot(description="Bot dyskorda /r/Polska", command_prefix=conf['prefix'])

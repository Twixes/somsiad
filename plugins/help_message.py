...
class Help(commands.Cog):
    COMMANDS = (
        ...
        _Help.Command(
            ('youtube', 'yt', 'tuba'),
            'zapytanie',
            'Zwraca z [YouTube](https://www.youtube.com) najlepiej pasujące do <zapytania> wideo.', '▶️'
        ),
        _Help.Command(
            ('wikipedia', 'wiki', 'w'),
        ...
        _Help.Command(
            ...
            'Przypomina o <treści> po upływie podanego czasu.', '🍅', ['przypomnij 21.08.2022T12:00 Wyłączyć piekarnik!']
        ),
        _Help.Command(
            ('spal', 'burn'),
            ('liczba minut/data i godzina', '?treść – może to też być załącznik'),
            'Usuwa wiadomość po upływie podanego czasu.', '🔥', ['spal 2h Nudesy']
        ),
        _Help.Command(
        ...
        _Help.Command(
            ...
            'Działa tylko dla członków serwera mających uprawnienia do wyrzucania innych.', '❗️'
        ),
        _Help.Command(
            ('kick', 'wyrzuć', 'wyrzuc'),
            ('użytkownik Discorda', 'powód'),

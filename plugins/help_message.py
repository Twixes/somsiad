...
class Help(commands.Cog):
    COMMANDS = (
        ...
        _Help.Command(
            ...
            "🇬",
            non_ai_usable=True,  # Custom Search API snippets are too low quality to be useful
        ),
        _Help.Command(
            ("googleimage", "gi", "i"),
            "zapytanie",
        ...
        _Help.Command(("^", "to", "this", "up", "upvote"), "?użytkownik Discorda", "⬆", "⬆", non_ai_usable=True),
        _Help.Command("f", "?użytkownik Discorda", "F", "🇫", non_ai_usable=True),
        _Help.Command(
            ("zareaguj", "reaguj", "x"),
        ...
        _Help.Command("oof", (), "Oof!", "😤", non_ai_usable=True),
        _Help.Command(
            "oof ile",
            "?użytkownik Discorda",
        ...
        _Help.Command(
            "oof serwer", (), "Zlicza oofnięcia na serwerze i generuje ranking ooferów.", "🤠", non_ai_usable=True
        ),
        _Help.Command(
        ...
        _Help.Command("tableflip", (), "(╯°□°）╯︵ ┻━┻", "🤬", non_ai_usable=True),
        _Help.Command("unflip", (), "┬─┬ ノ( ゜-゜ノ)", "😞", non_ai_usable=True),
        _Help.Command("shrug", (), r"¯\_(ツ)_/¯", "🤷", non_ai_usable=True),
        _Help.Command(("lenny", "lennyface"), (), "( ͡° ͜ʖ ͡°)", "😏", non_ai_usable=True),
        _Help.Command(("lenno", "lennoface"), (), "( ͡ʘ ͜ʖ ͡ʘ)", "😼", non_ai_usable=True),
        _Help.Command(("dej", "gib"), "?rzecz", "༼ つ ◕_◕ ༽つ <?rzecz>", "🤲", non_ai_usable=True),
        _Help.Command(
            ("nie", "nope", "no"),
            (),
        ...
        _Help.Command(("ping", "pińg"), (), "Pong!", "🏓", non_ai_usable=True),

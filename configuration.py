...
SETTINGS = (
    ...
    Setting('postgres_user', description='Nazwa użytkownika Postgresa'),
    Setting('postgres_password', description='Hasło użytkownika Postgresa'),
    Setting('postgres_db', description='Nazwa bazy danych Postgresa'),
